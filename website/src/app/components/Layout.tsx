  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Crimson Text, serif' }}>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrollY > 100 ? 'bg-[#1a2b5c]/95 backdrop-blur-md shadow-xl' : 'bg-[#1a2b5c]'
      }`}>
              ...
              {navItems.map((item, i) => (
                <Link key={item.path} to={item.path}>
                  <motion.div
                    ...
                    className={`text-white hover:text-[#FFD700] transition-colors cursor-pointer ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Library', 'Calendar', 'Parents Portal', 'Alumni'].map(link => (
                  <li key={link}>
