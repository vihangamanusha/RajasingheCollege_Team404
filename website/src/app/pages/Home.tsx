    ...
    <div>
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden mt-20">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[#1a2b5c]/70"></div>
        </div>
                  ...
                  <div className="relative inline-block">
                    ...
                    >
                      <ImageWithFallback
                        ...
                        className="w-full h-full object-cover"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#1a2b5c]/80 to-transparent"></div>
                    </motion.div>
                    <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-[30px] border-l-transparent border-r-[30px] border-r-transparent border-t-[30px] border-t-[#FFD700]"></div>
                  </div>
                </div>
