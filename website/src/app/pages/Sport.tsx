            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 pt-6">
                {[
                  ...
                  <div key={i} className="bg-gradient-to-br from-[#1a2b5c] to-[#1e3a8a] p-6 text-center text-white">
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-[#1a2b5c] to-[#1e3a8a]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-[#FFD700] to-transparent mx-auto mb-6"></div>
            ...
            {[
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1a2b5c] to-transparent"></div>
