...
export function SportAthletics() {
  ...
  const achievements = [
    {
      year: "2025",
      titleKey: "athletics.achievement1.title",
      descriptionKey: "athletics.achievement1.desc",
      image:
        "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=600&fit=crop",
    },
    {
      year: "2024",
      titleKey: "athletics.achievement2.title",
      descriptionKey: "athletics.achievement2.desc",
      image:
        "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=600&fit=crop",
    },
    {
      year: "2024",
      titleKey: "athletics.achievement3.title",
      descriptionKey: "athletics.achievement3.desc",
      image:
        "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=600&fit=crop",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl text-[#002147] mb-6">
                {t("sport.about")} {t("sports.athletics")} {t("sport.program")}
              </h2>
