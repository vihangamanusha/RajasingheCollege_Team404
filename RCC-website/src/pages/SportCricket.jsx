...
export function SportCricket() {
  ...
  const achievements = [
    {
      year: "2025",
      titleKey: "cricket.achievement1.title",
      descriptionKey: "cricket.achievement1.desc",
      image:
        "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=800&h=600&fit=crop",
    },
    {
      year: "2024",
      titleKey: "cricket.achievement2.title",
      descriptionKey: "cricket.achievement2.desc",
      image:
        "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=800&h=600&fit=crop",
    },
    {
      year: "2023",
      titleKey: "cricket.achievement3.title",
      descriptionKey: "cricket.achievement3.desc",
      image:
        "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=800&h=600&fit=crop",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-5xl text-[#002147] mb-6">
                {t("sport.about")} {t("sports.cricket")} {t("sport.team")}
              </h2>
