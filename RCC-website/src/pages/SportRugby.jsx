...
export function SportRugby() {
  ...
  const achievements = [
    {
      year: "2025",
      titleKey: "rugby.achievement1.title",
      descriptionKey: "rugby.achievement1.desc",
      image:
        "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&h=600&fit=crop",
    },
    {
      year: "2024",
      titleKey: "rugby.achievement2.title",
      descriptionKey: "rugby.achievement2.desc",
      image:
        "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&h=600&fit=crop",
    },
    {
      year: "2023",
      titleKey: "rugby.achievement3.title",
      descriptionKey: "rugby.achievement3.desc",
      image:
        "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&h=600&fit=crop",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl text-[#002147] mb-6">
                {t("sport.about")} {t("sports.rugby")} {t("sport.team")}
              </h2>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&h=800&fit=crop"
                alt="Rugby Team"
                className="w-full h-full object-cover"
              />
            </div>
