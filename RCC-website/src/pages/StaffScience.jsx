...
export function StaffScience() {
  ...
  const staff = [
    { name: "Dr. W.G. Silva", subject: "Physics", experience: "20 years" },
    { name: "Dr. K.M. Perera", subject: "Chemistry", experience: "18 years" },
    { name: "Prof. N.D. Fernando", subject: "Biology", experience: "16 years" },
  ];
    ...
    <div>
      ...
      <section className="relative h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#002147]/70 flex items-center justify-center">
          <h1 className="text-5xl md:text-6xl text-white">Science Staff</h1>
        </div>
      </section>
