...
export function StaffOLevel() {
  const { t } = useLanguage();

  const staff = [
    { name: "Dr. M.N. Jayasinghe", subject: "Mathematics", experience: "20 years" },
    { name: "Prof. S.K. Dhananjaya", subject: "English", experience: "18 years" },
    { name: "Mr. P.D. Kumara", subject: "Science", experience: "15 years" },
  ];
    ...
    <div>
      ...
      <section className="relative h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#002147]/70 flex items-center justify-center">
          <h1 className="text-5xl md:text-6xl text-white">O/L Staff</h1>
        </div>
      </section>
