...
export function StaffGrades69() {
  ...
  const staff = [
    { name: "Mr. K.D. Silva", subject: "Mathematics", experience: "18 years" },
    { name: "Mrs. R.P. Fernando", subject: "English", experience: "15 years" },
    { name: "Mr. A.K. Perera", subject: "Science", experience: "12 years" },
  ];
    ...
    <div>
      ...
      <section className="relative h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#002147]/70 flex items-center justify-center">
          <h1 className="text-5xl md:text-6xl text-white">Teaching Staff</h1>
        </div>
      </section>
